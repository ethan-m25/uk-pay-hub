#!/usr/bin/env python3
"""
uk-pay-hub/scripts/update-jobs.py
Daily job data updater — United Kingdom Pay Hub edition.
"""
...
def main():
        ...
        with open(raw_file) as f:
            for line in f:
                ...
                try:
                    ...
                    continue
                if not (15000 <= val_min < val_max <= 1_500_000):
                    continue
                job.setdefault("currency", "GBP")
                job.setdefault("region", "UK")
    ...
    db["meta"] = {
        ...
        "law": "Voluntary pay disclosure (UK)",
        "currency": "GBP",
        "region": "UK",
    }
