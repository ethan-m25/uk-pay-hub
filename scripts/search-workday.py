#!/usr/bin/env python3
"""
uk-pay-hub/scripts/search-workday.py
Workday API scraper — United Kingdom edition.

UK voluntary salary disclosure (Gender Pay Gap Reporting)

Strategy:
  1. Tenant discovery — Exa search finds *.myworkdayjobs.com URLs → extract United Kingdom employers
  2. CXS JSON API   — paginate all jobs per employer, filter United Kingdom (fast, no JS)
  3. HTML job page  — salary in raw HTML; pure regex, no LLM

Run: python3 ~/uk-pay-hub/scripts/search-workday.py
"""
...
# ── Seed tenants ─────────────────────────────────────────────────────────────
SEED_TENANTS = [
    ("hsbc.wd3.myworkdayjobs.com", "hsbc", "external", "HSBC"),
    ("barclays.wd3.myworkdayjobs.com", "barclays", "External", "Barclays"),
    ("lloydsbankinggroup.wd3.myworkdayjobs.com", "lloydsbankinggroup", "External", "Lloyds Banking Group"),
    ("standardchartered.wd3.myworkdayjobs.com", "standardchartered", "StanChart", "Standard Chartered"),
    ("bp.wd3.myworkdayjobs.com", "bp", "BPSourcing", "BP"),
    ("shell.wd3.myworkdayjobs.com", "shell", "External", "Shell"),
    ("riotinto.wd3.myworkdayjobs.com", "riotinto", "External", "Rio Tinto"),
    ("gsk.wd3.myworkdayjobs.com", "gsk", "jobopportunities", "GSK"),
    ("astrazeneca.wd3.myworkdayjobs.com", "astrazeneca", "AstraZenecaExternalCareers", "AstraZeneca"),
    ("unilever.wd3.myworkdayjobs.com", "unilever", "External", "Unilever"),
    ("vodafone.wd3.myworkdayjobs.com", "vodafone", "External", "Vodafone"),
    ("rolls-royce.wd3.myworkdayjobs.com", "rolls-royce", "External", "Rolls-Royce"),
    ("baesystems.wd3.myworkdayjobs.com", "baesystems", "External", "BAE Systems"),
    ("diageo.wd3.myworkdayjobs.com", "diageo", "External", "Diageo"),
...
KNOWN_COMPANY_OVERRIDES = {
    "hsbc": "HSBC",
    "barclays": "Barclays",
    "lloydsbankinggroup": "Lloyds Banking Group",
...
DISCOVERY_QUERIES = [
    'site:myworkdayjobs.com "United Kingdom" salary 2026',
    'site:myworkdayjobs.com "London" salary "£" OR "GBP" 2026',
    'site:myworkdayjobs.com "Manchester" OR "Birmingham" OR "Leeds" salary 2026',
    'site:myworkdayjobs.com UK finance OR banking OR pharma salary range 2026',
    'site:myworkdayjobs.com "Edinburgh" OR "Glasgow" OR "Bristol" salary 2026',
    'site:myworkdayjobs.com United Kingdom tech OR consulting salary 2026',
]
